...
class AgentTools:
    ...
    async def _read_url(self, args: dict) -> dict:
        ...
        allowed = ("eastmoney.com", "wallstreetcn.com", "cls.cn", "10jqka.com.cn", "xueqiu.com",
                   "sse.com.cn", "szse.cn", "cnbc.com", "marketwatch.com", "seekingalpha.com",
                   "reuters.com", "morningstar.cn", "morningstar.com")
        if parsed.scheme not in ("http", "https") or not any(host == x or host.endswith("." + x) for x in allowed):
        ...
        if not any(final_host == x or final_host.endswith("." + x) for x in allowed):
